...
<div class="container">
    <center>
        <div class="totaltransaksi  ms-3 justify-content-center">
            ...
            <h4>Total Investor Keseluruhan :</h4>
            <h2 style="color: #25C517;">1276 Investor</h2>
            <br>
            <h4> Investor Baru Hari Ini :</h4>
            <h2 style="color: #25C517;">+3 Investor</h2>
    ...
    <div class="container row d-flex justify-content-strat">
        ...
        <div class="input-group rounded justify-content-strat" style="width: 300px;">
            <input type="search" class="form-control rounded rounded-pill border-3"
                placeholder="Cari Investor  Disini" aria-label="Search" aria-describedby="search-addon" />
            ...
            <table class="table " style="color: black;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.data-investor') }}" class="btn btn-primary rounded-pill col-md-12">
                                Periksa</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="data-investor.html" class="btn btn-primary rounded-pill col-md-12">
                                Periksa</a>
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="row ">
                ...
                <div class="col-sm-12 col-xl-10">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">Grafik Pertumbuhan Investor</h6>
