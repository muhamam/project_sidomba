                ...
                <div class="kabeh rounded-lg" style="border: 1px solid #000; height: 380px; ">
                    ...
                    <div class="row gutters-sm mt-4 ml-1">
                        ...
                        <div class="row d-flex justify-content-center">
                            <a href="#" class="btn btn-primary col-2 mr-3" style="border-radius:15px; ">Selesaikan</a>
                            <a href="#" class="btn btn-danger col-2 " style="border-radius:15px; ">Ajukan
                                Komplain</a>
                        </div>
                    </div>
                </div>
                                ...
                                <center>
                                    <div class="">
                                        ...
                                        <a type="button" href="#" class="btn btn-primary " data-toggle="modal"
                                            data-target="#exampleModal-1" style=" font-size:11px;">Detail</a>
                                    </div>
                                </center>
                                <!-- Modal -->
