...
<div class="row">
    ...
    <section class="ftco-section col " style="margin-top: 50px;">
        <div class="container " style="background-color: white; width: 994px; border-radius: 15px;">
            ...
            <div class="" style="border:1px solid black ; padding:20px;  border-radius:20px; margin-bottom:20px;">
                <div class="row mb-3">
                                            ...
                                            <div class="p-0">
                                                ...
                                                <center>
                                                    ...
                                                    <div class="col-10">
                                                        ...
                                                        <a href="#" class="btn btn-primary mt-3">Batal Komplain</a>
                                                    </div>
                                                </center>
                                            </div>
                                            <br>
                    ...
                    <div class="row gutters-sm mt-4 ml-1">
                        ...
                        <div class="col-3 " style="padding:0;">
                            <center>
                                ...
                                <div class="modal fade" id="exampleModal-4" aria-labelledby="exampleModalLabel">
                                    <div class="modal-dialog ">
                                        <div class="modal-content">
                                            <div class="p-0">
                                                <div class="row" id="exampleModalLabel">
                                                    ...
                                                    <center>
                                                        <div class="col-8"
                                                            ...
                                                            <h6>Solusi</h6>
                                                            <a href="#">Retur Domba</a>
                                                            <p>Jangka waktu retur : 7 hari dari sekarang</p>
                                                            <div class="dotted col-10"></div>
                                                            <h6>Lakukan retur dalam</h6>
                                                            <a href="#">167 : 59 : 59</a>
                                                        </div>
                                                    </center>
                                                    <br>
                                                    ...
                                                    <center>
                                                        <div class="col-12">
                                                            <h5>Penyelesaian Retur</h5>
                                                            <h6>Tanggal Retur Domba :</h6>
                                                            <form>
                                                                <input type="date" class="col-10">
                                                            </form>
                                                            <h6>Bukti Retur : </h6>
                                                            <center>
                                                            ...
                                                            <a href="#" class="btn btn-primary">Selesaikan Retur</a>
                                                            <a href="#" class="btn btn-primary">Batalkan Komplain</a>
                                                        </div>
                                                    </center>
                                                </div>
                ...
                <!-- konfirmasi solusi di setujui peternak star -->
                <div class="kabeh rounded-lg mt-4" style="border: 1px solid #000; ">
                    <div class="row mt-3">
                        <p class="col-3 ml-4 " style="border-right:1px solid black ; "><b>Invoice :
                                INV/001/052022 </b></p>
                    ...
                    <div class="row gutters-sm mt-4 ml-1">
                        ...
                        <div class="col-3 " style="padding:0;">
                            <center>
                                <h5>Aksi</h5>
                                <p style="color:#AC17F2;">Peternak sudah mengkonfirmasi retur. Domba akan segera dikirim
                                </p>
                                <!-- Modal start-->
                                <div class="row d-flex justify-content-center">
                                    <a href="#" class="col-4 btn btn-outline-primary mr-4" data-toggle="modal"
                ...
                <!-- konfirmasi solusi di setujui peternak end -->
                <!-- konfirmasi domba dikirim peternak star -->
                <div class="kabeh rounded-lg mt-4" style="border: 1px solid #000; ">
                    <div class="row mt-3">
                        <p class="col-3 ml-4 " style="border-right:1px solid black ; "><b>Invoice :
                                INV/001/052022 </b> </p>
                    ...
                    <div class="row gutters-sm mt-4 ml-1">
                        ...
                        <div class="col-4 row" style="margin-left:-35px;">
                            <center>
                                <div class="col ">
                                    <h5>Status</h5>
                                    <h6><a class="" href="#" style="color:#3A8BCD;">Peternak sudah mengkonfirmasi
                                            retur.
                                            Domba akan segera dikirim</a></h6>
                                </div>
                            </center>
                        </div>
                        <div class="col-3 " style="padding:0;">
                            <center>
                                <h5>Aksi</h5>
                                <p style="color:#AC17F2;">Sedang mengirim domba</p>
                                <!-- Modal start-->
                                <div class="row d-flex justify-content-center">
                                    <a href="#" class="col-4 btn btn-outline-primary mr-4" data-toggle="modal"
                                        data-target="#exampleModal-5" style="border-radius:5px; ">Detail</a>
                ...
                <!-- konfirmasi domba dikirim peternak end -->
                <!-- konfirmasi domba telah sampai star -->
                <div class="kabeh rounded-lg mt-4" style="border: 1px solid #000; ">
                    <div class="row mt-3">
                        <p class="col-3 ml-4 " style="border-right:1px solid black ; "><b>Invoice :
                                INV/001/052022 </b></p>
                    ...
                    <div class="row gutters-sm mt-4 ml-1">
                        ...
                        <div class="col-3 " style="padding:0;">
                            <center>
                                <h5>Aksi</h5>
                                <p style="color:#3ACD52;">Domba telah tiba di tujuan. Harap segera konfirmasi</p>
                                <!-- Modal start-->
                                <div class="row d-flex justify-content-center">
                                    <a href="#" class="col-4 btn btn-outline-primary mr-4" data-toggle="modal"
                                        data-target="#exampleModal-5" style="border-radius:5px; ">Detail</a>
                                    <a href="#" class="col-5 btn btn-primary mr-4" data-toggle="modal"
                                        data-target="#exampleModal-6" style="border-radius:5px; ">Konfirmasi</a>
                                    <div class="modal fade" id="exampleModal-6" aria-labelledby="exampleModalLabel">
                                        <div class="modal-dialog ">
                                            <div class="modal-content">
                                                <div class="p-0">
                                                    <div id="exampleModalLabel">
                                                        <center>
                                                            <h3>Selesaikan Retur</h3>
                                                            <h6>Detail Return</h6>
                                                            <table class="mb-3">
                                                                <thead>
                                                                    <tr>
                                                            ...
                                                            <table class="mb-3">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <th scope="row">Tanggal Tiba</th>
                                                                        <td></td>
                                                                        <td>:</td>
                                                                        <td><a href="#">29/07/2022</a></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th scope="row">Alamat Retur</th>
                                                                        <td></td>
                                                                        <td>:</td>
                                                                        <td>Jl. Siliwangi No. 99, Tugujaya, Kota
                                                                            Tasikmalaya
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                            ...
                                                            <p>Dengan menyelesaikan komplain ini, maka transaksi ini
                                                                akan berpindah dari menu komplain ke tab Transaksi >
                                                                Selesai. Jika pesanan masih salah, Anda bisa mengajukan
                                                                komplain lagi . Terimakasih atas kerjasamanya!</p>
                                                            <a href="#" class="btn btn-primary mb-3">Konfirmasi</a>
                                                        </center>
                                                    </div>
                            </center>
                        </div>
                ...
                <!-- konfirmasi domba telah sampai end -->
                <!-- Komplain selesai start -->
                <div class="kabeh rounded-lg mt-4" style="border: 1px solid #000; ">
                    <div class="row mt-3">
                        <p class="col-3 ml-4 " style="border-right:1px solid black ; "><b>Invoice :
                                INV/001/052022 </b> </p>
                    ...
                    <div class="row gutters-sm mt-4 ml-1">
                        ...
                        <div class="col-4 row" style="margin-left:-35px;">
                            <center>
                                <div class="col ">
                                    <h5>Status</h5>
                                    <h6><a class="" href="#" style="color:#3A8BCD;">Komplain selesai</a></h6>
                                </div>
                            </center>
                        </div>
                        <div class="col-3 " style="padding:0;">
                            <center>
                                <h5>Aksi</h5>
                                <p style="color:#F77E21;">Komplain ini telah selesai. Harap segera menyelesaikan
                                    transaksi pada <a href="#">Transaksi </a> > <a href="#">Selesai</a> </p>
                                <!-- Modal start-->
                                <div class="row d-flex justify-content-center">
                                    <a href="#" class="col-4 btn btn-outline-primary mr-4" data-toggle="modal"
                                        data-target="#exampleModal-7" style="border-radius:5px; ">Detail</a>
                                    <div class="modal fade" id="exampleModal-7" aria-labelledby="exampleModalLabel">
                                        <div class="modal-dialog ">
                                            <div class="modal-content">
                                                <div class="p-0">
                                                    <div class="row" id="exampleModalLabel">
