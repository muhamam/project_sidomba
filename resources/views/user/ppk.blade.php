            ...
            <div class="pb-5 " style="border:1px solid black ; padding:20px;  border-radius:20px;">
                ...
                <div class="kabeh rounded-lg" style="border: 1px solid #000; ">
                    ...
                    <div class="row d-flex justify-content-around">
                        <a href="#" class="btn btn-outline-primary col-3">Domba Memiliki
                            Penyakit</a>
                        <a href="#" class="btn btn-outline-primary col-5">Berat Domba Tidak
                            Sesuai Dengan Yang
                            Tertera</a>
                    ...
                    <div class="">
                        <div class="form-group  col-11 ml-3 " style="border: 1px solid black;">
