...
<div class="row">
    ...
    <section class="ftco-section col " style="margin-top: 95px;">
        ...
        <div class="row">
            <div class="container col-8" style="background-color: white; width: 994px;border-radius:10px;">
                <center>
                    <h3>Keranjang</h3>
                </center>
                <br>
                <div style="border-radius:10px; border: 1px solid #000; height: 380px; ">
                    <div class="row mt-3">
                    ...
                    <div class="row ml-5">
                        ...
                        <a href="#" class="btn btn-outline-primary col-3" style="border-radius: 45px;"> Sedang
                            Berlangsung</a>
                    </div>
                ...
                <div class="d-flex justify-content-end">
                    <div class="row col-6">
                        ...
                        <h5 class="col-2">:</h5>
                        <h5 class="col-5">Rp2.900.000,00</h5>
                    </div>
                </div>
            </div>
            <div class="col-3" style="border-radius: 10px; background-color: white;">
                <h6>Pesanan</h6>
                <ul>
                    <li>1x Domba Suffolk</li>
                    <li>1x Domba Texel</li>
                </ul>
                <div class=" dotted col-md-10"></div>
                <br>
                <h6>Alamat Pengiriman</h6>
                <div class="form-group">
                    <label for="exampleFormControlSelect1">Alamat Utama</label>
