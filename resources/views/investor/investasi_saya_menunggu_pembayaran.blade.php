        ...
        <div class="container bg-light" style="background-color: white; border-radius:20px;">
            ...
            <div class="kabeh rounded-lg" style="border: 1px solid #000; height: 380px; ">
                ...
                <div class="row gutters-sm mt-2 ml-1">
                    ...
                    <div class="col-md-5 ml-4  " style="font-size:12px ;">
                        <div class="row">
                            <table>
                                <thead>
                                    <tr>
                                        <th colspan="2">
                                            <h6><b> Domba Suffolk </b></h6>
                                        </th>
                                        <th scope="col"></th>
                                        <th scope="col"></th>
                                        <th scope="col"></th>
                        ...
                        <br>
                        <center>
                            <div class="col-15" style="border-radius: 15px; border:1px solid black;">
                    ...
                    <div class="col-3 " style="margin-left:100px">
                        <div class="col-12" style="border-radius: 15px; border:1px solid black;">
                            <center> <span class="iconify" data-icon="icon-park:error-picture" data-width="75"
                                    data-height="75"></span>
                                <p><b> Anda Belum Mengajukan Bukti Transfer</b></p>
                        ...
                        <center><a type="button" href="#" class="btn btn-primary " data-toggle="modal"
                                data-target="#exampleModal-1" style=" font-size:15px;">Detail</a></center>
                    </div>
                                                    ...
                                                    <div class="">
                                                        <div class="">
                                                            <a href="btn" data-bs-toggle="modal"
                                                                ...
                                                                <img class="rounded" src="../img/1.jpg" width="200px"
                                                                    height="200px">
                                                            </a>
                                            ...
                                            <center>
                                                <div class="mt-4">
                                                    <h5 style="margin-left:120px;"><b> Nominasi
                                                            Investasi</b></h5>
                                                    <h3 style="margin-left:120px;"><a href="#">Rp1.450.000,00</a>
                                                    </h3>
                                                </div>
                                            </center>
