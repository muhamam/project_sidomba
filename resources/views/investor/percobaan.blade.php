...
<div class="row d-flex">
    <div class="col-3" style=" margin-top:150px;">
        <div class=" bg-light  ">
            <center>
                ...
                <div class="dalam ">
                    <span class="iconify" data-icon="eva:home-outline" data-width="25" data-height="25" style="margin-right: 130px; margin-bottom: -60px;"></span>

                    <a href="dashboard_investor.html" class="dropdown-item ">Beranda</a>
                    <span class="iconify" data-icon="healthicons:market-stall-outline" data-width="25" data-height="25" style="margin-right: 130px; margin-bottom: -60px;"></span>
                    ...
                    <span class="iconify" data-icon="ant-design:history-outlined" data-width="25" data-height="25" style="margin-right: 130px; margin-bottom: -60px;"></span>

                    <a href="investasi_riwayat.html" class="dropdown-item">Riwayat</a>
                    <span class="iconify" data-icon="mdi:account-cash" data-width="25" data-height="25" style="margin-right: 130px; margin-bottom: -60px;"></span>
    ...
    <div class="col-8 " style="margin-top: 100px;">
        <div class="tengah d-flex d-flex justify-content-center " style="margin-bottom: 20px; margin-top:-50px; margin-left: -300px;">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center ml-3" style="background-color: white; width: 1000px">
                            ...
                            <div class="d-flex flex-column  text-center ">
                                ...
                                <div class="col d-flex justify-content-between">
                                    <a href="btn" data-bs-toggle="modal" data-bs-target="#exampleModal1">
                                        <img class="slide1 rounded ml-3" src="../img/2.jpg" alt="" width="80" height="70">
                                    </a>
                                    ...
                                    <a href="btn" data-bs-toggle="modal" data-bs-target="#exampleModal3">
                                        <img class="slide3 rounded mr-1" src="../img/4.jpg" alt="" width="80" height="70">
                                    </a>
                                    ...
                                    <a href="btn" data-bs-toggle="modal" data-bs-target="#exampleModal4">
                                        <img class="slide4 rounded mr-4 " src="../img/5.jpg" alt="" width="80" height="70">
                                    </a>
                ...
                <div class="dekripsi ml-4 mr-3 mt-2">
                    ...
                    <div class="  row" style="border: 1px solid #000; margin-top: 10px;  background-color: white;">
                        ...
                        <div class="col" style="width:990px;height: 247px;">
                            ...
                            <table>
                                <tr>
                                    <img class="rounded-circle" src="../img/user.jpeg" alt="" style="width:60px ;height :60px; ">
                                    <th></th>

                                    <span class="iconify ml-2" data-icon="flat-color-icons:rating" data-width="15" data-height="15"></span>
                                    <span class="iconify" data-icon="flat-color-icons:rating" data-width="15" data-height="15"></span>
                                    <span class="iconify" data-icon="flat-color-icons:rating" data-width="15" data-height="15"></span>
                                    <span class="iconify" data-icon="flat-color-icons:rating" data-width="15" data-height="15"></span>
                                    <span class="iconify" data-icon="flat-color-icons:rating" data-width="15" data-height="15"></span>
                                    <span class="iconify p-2" data-icon="flat-color-icons:rating" data-width="15" data-height="15" style="border-right: 1px solid #3A8BCD;"></span>
                ...
                <div class="col-md-12">
                                ...
                                <div class="row " alt="First slide">
                                    <div class="item col">
                                        <div class="work1" style="border: 1px solid #000000; width: 390px; margin-left: 50px;">
                                            <div class="img d-flex align-items-center  rounded" style="background-image: url(../img/1.jpg); width: 100%;height: 198px; ">
                                            </div>
                                            <div class="caption1 col-sm">
                                                ...
                                                <div class="garis" style="width: 100%; height: 2px; background-color: #000000; margin-top: -10px;">
                                                </div>
                                                <br>
                                                ...
                                                <div class="garis mt-1" style="width: 100%; height: 2px; background-color: #000000; margin-top: -10px;">
                                                </div>
                                                <div class="row mt-2">
                    ...
                    <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev" style="background-color: black; width: 40px; height: 50px; margin-top: 300px;">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    </a>
                    <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next" style="background-color: black;width: 40px; height: 50px; margin-top:
                            300px;">
