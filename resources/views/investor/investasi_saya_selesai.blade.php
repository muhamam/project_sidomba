    ...
    <section class="ftco-section col" style="margin-top: 100px;">
        ...
        <div class="container " style="background-color: white; width: 994px;">
            ...
            <div class="d-flex flex-row mt-5  ml-3">
                <a class="" href="investasi_saya_semua.html" style="color: #000;">
                    <h5>Berjalan</h5>
                </a>
                <a class="ml-4" href="investasi_saya_selesai.html" style="color: #000;">
                    <h5> Selesai</h5>
                </a>
                <a class="ml-4" href="investasi_saya_negosiasi.html" style="color: #000;">
            ...
            <div class="kabeh rounded-lg" style="border: 1px solid #000; height: 380px; ">
                ...
                <div class="row gutters-sm mt-4 ml-1">
                    ...
                    <div class="col-5 row" style="margin-left:-50px;">
                        <div class="col ">
                    ...
                    <div class="col-2 " style="padding:0;">
                        <div class="" style=" ">
                            <div class="">
                                <h6 style=" font-size:11px; margin-left:17px;"><b> Laba Bersih</b></h6>
                                ...
                                <a type="button" href="#" class="btn btn-primary " data-toggle="modal"
                                    data-target="#exampleModal-1" style=" font-size:11px;">Pertinjau
                                    Investasi</a>
                            </div>
                    ...
                    <div class="col-2 " style="padding:0;">
                        <div class="" style=" ">
                            <div class="">
                                ...
                                <h3><a class="ml-1" href="#" style=" font-size:15px; color: rgb(255, 0, 0);">-
                                        Rp400.000,00</a>
                                </h3>
                                <!-- Button trigger modal -->
                                <a type="button" href="#" class="btn btn-primary " data-toggle="modal"
