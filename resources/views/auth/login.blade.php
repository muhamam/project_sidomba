...
<div class="container">
    <center>
        <h6><b>SILAHKAN DAFTAR JIKA BELUM MEMPUNYAI AKUN</b></h6>
    </center>
    <div class="body d-md-flex align-items-center justify-content-between">
        ...
        <div class="box-1">
            ...
            <div class="text-center" style="margin-top: 8rem;">
                <br><br>
                <a style="color: white; font-size:25px;"><b> Hello, Guys...</b></a>
                <br>
                <b><small style=" color: white;">Silahkan buat daftar jika belum mempunyai akun</small></b>
                <br>
                <br>
        ...
        <div class=" box-2 d-flex flex-column h-100">
            <div class="mt-3">
                <p class="text-center h-1">Login</p>
